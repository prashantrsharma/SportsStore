...
namespace SportsStore.UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void CanPaginate()
        {
            ...
            //Act
            Product[] productArray = ((ProductsListViewModel)controller.List(null,2).Model).Products.ToArray();
        ...
        public void Can_Filter_Products()
        {
            ...
            //Assert
            Product[] result = ((ProductsListViewModel) 
                    controller.List("Cat2",1).Model).Products
                    .ToArray();
